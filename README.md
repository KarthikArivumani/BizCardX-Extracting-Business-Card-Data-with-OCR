...
BizCardX: Extracting Business Card Data with OCR Technologies Used : Python,easy OCR, Streamlit, SQL, Pandas Overview : In this streamlit web app you can extract relevant information from it using easyOCR. You can view, modify or delete the extracted data in this app. This app would also allow users to save the extracted information into a database along with the uploaded business card image. The database would be able to store multiple entries, each with its own business card image and extracted information.
...
Test the application: Test the application thoroughly to ensure that it works as expected. You can run the application on your local machine by running the command streamlit run testbiz.py in the terminal, where testbiz.py is the name of your Streamlit application file.
